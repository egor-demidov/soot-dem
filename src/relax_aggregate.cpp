...
int main(int argc, const char ** argv) {
    ...
    print_header(parameter_store, "relax_aggregate");

    if (parameter_store.simulation_type != "relaxation") {
        std::cerr << "Parameter file simulation type must be `relaxation`" << std::endl;
        exit(EXIT_FAILURE);
    }
