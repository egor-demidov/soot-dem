...
#ifndef SOOT_AFM_AGGREGATE_BREAKING_NECKS_H
#define SOOT_AFM_AGGREGATE_BREAKING_NECKS_H
...
struct aggregate_breaking_necks {

    typedef contact_force_functor<field_value_t, real_t> contact_model_t;
    typedef alt_breaking_sinter_functor<field_value_t, real_t, neck_strength_distribution_t> sinter_model_t;
    typedef hamaker_functor<field_value_t, real_t> hamaker_model_t;

    aggregate_breaking_necks(
    ...
    contact_model {
        ...
        r_part, mass, inertia, dt, field_zero, real_zero, critical_separation, neck_strength_distribution, contact_model
    }, hamaker_model {
...
#endif //SOOT_AFM_AGGREGATE_BREAKING_NECKS_H
